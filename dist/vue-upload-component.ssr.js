...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VueUploadComponent = factory(global.Vue, global.VueServerRenderer));
  ...
  function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    ...
    if (!_ctx.reload) {
      ...
      (serverRenderer.ssrIncludeBooleanAttr(_ctx.disabled)) ? " disabled" : ""
    }${
      serverRenderer.ssrRenderAttr("webkitdirectory", _ctx.iDirectory)
    }${
      serverRenderer.ssrRenderAttr("allowdirs", _ctx.iDirectory)
    }${
      serverRenderer.ssrRenderAttr("directory", _ctx.iDirectory)
    }${
      (serverRenderer.ssrIncludeBooleanAttr(_ctx.multiple && _ctx.features.html5)) ? " multiple" : ""
    }>`);
    } else {
      _push(`<!---->`);
    }
